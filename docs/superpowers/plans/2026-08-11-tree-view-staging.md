...
> **Status: SUPERSEDED — do not execute.** A4/A5/A6 shipped via #73 (`997e1ab`)
> using a different structure. This plan was executed in full on
> `feat/tree-view-staging` (PR #72, closed as duplicate); it is retained only as
> the record of that alternative. See the superseded banner on
> `docs/superpowers/specs/2026-08-11-tree-view-staging-design.md` for the
